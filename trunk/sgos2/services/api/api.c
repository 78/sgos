...
type __attribute__((stdcall)) sys_##name(void) \
{ \
	long result; \
...
type __attribute__((stdcall)) sys_##name(atype a) \
{ \
	long result; \
...
type __attribute__((stdcall)) sys_##name(atype a,btype b) \
{ \
	long result; \
	__asm__ __volatile__ ("int $0xA0" \
	: "=a" (result) \
...
type __attribute__((stdcall)) sys_##name(atype a,btype b,ctype c) \
{ \
	long result; \
	__asm__ __volatile__ ("int $0xA0" \
	: "=a" (result) \
